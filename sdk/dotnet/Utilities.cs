...
namespace dirien.Vultr
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/dirien/pulumi-vultr";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("dirien.Vultr.version.txt");
    ...
    internal sealed class VultrResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public VultrResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
