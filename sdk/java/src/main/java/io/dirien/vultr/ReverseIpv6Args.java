...
public final class ReverseIpv6Args extends com.pulumi.resources.ResourceArgs {

    public static final ReverseIpv6Args Empty = new ReverseIpv6Args();
    ...
    private ReverseIpv6Args() {}

    private ReverseIpv6Args(ReverseIpv6Args $) {
    ...
    public static Builder builder(ReverseIpv6Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ReverseIpv6Args defaults) {
            $ = new ReverseIpv6Args(Objects.requireNonNull(defaults));
        }
