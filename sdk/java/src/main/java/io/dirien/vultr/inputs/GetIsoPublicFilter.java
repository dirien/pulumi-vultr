...
public final class GetIsoPublicFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetIsoPublicFilter Empty = new GetIsoPublicFilter();
    ...
    private GetIsoPublicFilter(GetIsoPublicFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIsoPublicFilter();
        }

        public Builder(GetIsoPublicFilter defaults) {
            $ = new GetIsoPublicFilter(Objects.requireNonNull(defaults));
        }
