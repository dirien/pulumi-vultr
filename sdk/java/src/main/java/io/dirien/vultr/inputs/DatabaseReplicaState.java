...
public final class DatabaseReplicaState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param clusterTimeZone The configured time zone for the managed database read replica in TZ database format.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param databaseEngine The database engine of the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param databaseEngineVersion The database engine version of the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dateCreated The date the managed database read replica was added to your Vultr account.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dbname The managed database read replica&#39;s default logical database.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param host The hostname assigned to the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param latestBackup The date of the latest backup available on the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param maintenanceDow The preferred maintenance day of week for the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param maintenanceTime The preferred maintenance time for the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param password The password for the managed database read replica&#39;s primary admin user.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param plan The managed database read replica&#39;s plan ID.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param planRam The amount of memory available on the managed database read replica in MB.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param planReplicas The number of standby nodes available on the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param planVcpus The number of virtual CPUs available on the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param port The connection port for the managed database read replica.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param status The current status of the managed database read replica (poweroff, rebuilding, rebalancing, running).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param user The primary admin user for the managed database read replica.
         * 
         * @return builder
         * 
         */
