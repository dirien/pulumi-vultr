...
public final class GetBareMetalPlanFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetBareMetalPlanFilter Empty = new GetBareMetalPlanFilter();
    ...
    private GetBareMetalPlanFilter(GetBareMetalPlanFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBareMetalPlanFilter();
        }

        public Builder(GetBareMetalPlanFilter defaults) {
            $ = new GetBareMetalPlanFilter(Objects.requireNonNull(defaults));
        }
