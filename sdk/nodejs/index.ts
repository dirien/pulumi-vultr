...
export { GetObjectStorageTierArgs, GetObjectStorageTierResult, GetObjectStorageTierOutputArgs } from "./getObjectStorageTier";
...
export { GetVirtualFileSystemStorageArgs, GetVirtualFileSystemStorageResult, GetVirtualFileSystemStorageOutputArgs } from "./getVirtualFileSystemStorage";
export const getVirtualFileSystemStorage: typeof import("./getVirtualFileSystemStorage").getVirtualFileSystemStorage = null as any;
export const getVirtualFileSystemStorageOutput: typeof import("./getVirtualFileSystemStorage").getVirtualFileSystemStorageOutput = null as any;
utilities.lazyLoad(exports, ["getVirtualFileSystemStorage","getVirtualFileSystemStorageOutput"], () => require("./getVirtualFileSystemStorage"));
...
export { VirtualFileSystemStorageArgs, VirtualFileSystemStorageState } from "./virtualFileSystemStorage";
export type VirtualFileSystemStorage = import("./virtualFileSystemStorage").VirtualFileSystemStorage;
export const VirtualFileSystemStorage: typeof import("./virtualFileSystemStorage").VirtualFileSystemStorage = null as any;
utilities.lazyLoad(exports, ["VirtualFileSystemStorage"], () => require("./virtualFileSystemStorage"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "vultr:index/virtualFileSystemStorage:VirtualFileSystemStorage":
                return new VirtualFileSystemStorage(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("vultr", "index/virtualFileSystemStorage", _module)
