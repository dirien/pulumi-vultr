...
export class SnapshotFromUrl extends pulumi.CustomResource {
     ...
     */
    public readonly useUefi!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: SnapshotFromUrlArgs | SnapshotFromUrlState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["useUefi"] = state ? state.useUefi : undefined;
        } else {
            ...
            resourceInputs["useUefi"] = args ? args.useUefi : undefined;
