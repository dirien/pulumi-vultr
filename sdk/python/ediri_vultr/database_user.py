...
class DatabaseUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_id: The managed database ID you want to attach this user to.
        :param pulumi.Input[builtins.str] username: The username of the new managed database user.
        :param pulumi.Input[builtins.str] encryption: The encryption type of the new managed database user's password (MySQL engine types only - `caching_sha2_password`, `mysql_native_password`).
        :param pulumi.Input[builtins.str] password: The password of the new managed database user.
        :param pulumi.Input[builtins.str] permission: The permission level for the database user (Kafka engine types only - `admin`, `read`, `write`, `readwrite`).
        """
...
class DatabaseUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            permission: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseUser':
        """
