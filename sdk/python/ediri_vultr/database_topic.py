...
class DatabaseTopicArgs:
    def __init__(__self__, *,
                 ...
                 retention_bytes: pulumi.Input[builtins.int],
                 retention_hours: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a DatabaseTopic resource.
        :param pulumi.Input[builtins.str] database_id: The managed database ID you want to attach this topic to.
        :param pulumi.Input[builtins.str] name: The name for the new managed database topic.
        :param pulumi.Input[builtins.int] partitions: The number of partitions for the new managed database topic.
        :param pulumi.Input[builtins.int] replication: The replication factor for the new managed database topic.
        :param pulumi.Input[builtins.int] retention_bytes: The retention bytes for the new managed database topic.
        :param pulumi.Input[builtins.int] retention_hours: The retention hours for the new managed database topic.
        """
    ...
    def retention_bytes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def retention_bytes(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "retention_bytes", value)

    @property
    @pulumi.getter(name="retentionHours")
    def retention_hours(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def retention_hours(self, value: pulumi.Input[builtins.int]):
...
class _DatabaseTopicState:
    def __init__(__self__, *,
                 ...
                 retention_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 retention_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="retentionBytes")
    def retention_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The retention bytes for the new managed database topic.
        """
        return pulumi.get(self, "retention_bytes")
    ...
    @retention_bytes.setter
    def retention_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retention_bytes", value)

    @property
    @pulumi.getter(name="retentionHours")
    def retention_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The retention hours for the new managed database topic.
        """
        return pulumi.get(self, "retention_hours")
    ...
    @retention_hours.setter
    def retention_hours(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retention_hours", value)
...
class DatabaseTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            replication: Optional[pulumi.Input[builtins.int]] = None,
            retention_bytes: Optional[pulumi.Input[builtins.int]] = None,
            retention_hours: Optional[pulumi.Input[builtins.int]] = None) -> 'DatabaseTopic':
        """
    ...
    @property
    @pulumi.getter(name="retentionBytes")
    def retention_bytes(self) -> pulumi.Output[builtins.int]:
        """
        The retention bytes for the new managed database topic.
        """
        return pulumi.get(self, "retention_bytes")
    ...
    @property
    @pulumi.getter(name="retentionHours")
    def retention_hours(self) -> pulumi.Output[builtins.int]:
        """
        The retention hours for the new managed database topic.
        """
        return pulumi.get(self, "retention_hours")
