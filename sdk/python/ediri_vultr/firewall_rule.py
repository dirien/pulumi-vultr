...
class FirewallRuleArgs:
    def __init__(__self__, *,
                 firewall_group_id: pulumi.Input[builtins.str],
                 ip_type: pulumi.Input[builtins.str],
                 protocol: pulumi.Input[builtins.str],
                 subnet: pulumi.Input[builtins.str],
                 subnet_size: pulumi.Input[builtins.int],
                 notes: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FirewallRule resource.
        :param pulumi.Input[builtins.str] firewall_group_id: The firewall group that the firewall rule will belong to.
        :param pulumi.Input[builtins.str] ip_type: The type of ip for this firewall rule. Possible values (v4, v6) **Note** they must be lowercase
        :param pulumi.Input[builtins.str] protocol: The type of protocol for this firewall rule. Possible values (icmp, tcp, udp, gre, esp, ah) **Note** they must be lowercase
        :param pulumi.Input[builtins.str] subnet: IP address that you want to define for this firewall rule.
        :param pulumi.Input[builtins.int] subnet_size: The number of bits for the subnet in CIDR notation. Example: 32.
        :param pulumi.Input[builtins.str] notes: A simple note for a given firewall rule
        :param pulumi.Input[builtins.str] port: TCP/UDP only. This field can be a specific port or a colon separated port range.
        :param pulumi.Input[builtins.str] source: Possible values ("", cloudflare)
        """
    ...
    def firewall_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def firewall_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def subnet_size(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @subnet_size.setter
    def subnet_size(self, value: pulumi.Input[builtins.int]):
...
class _FirewallRuleState:
    def __init__(__self__, *,
                 ...
                 subnet_size: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="subnetSize")
    def subnet_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of bits for the subnet in CIDR notation. Example: 32.
        """
        return pulumi.get(self, "subnet_size")
    ...
    @subnet_size.setter
    def subnet_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "subnet_size", value)


@pulumi.type_token("vultr:index/firewallRule:FirewallRule")
class FirewallRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[builtins.str]] = None,
            subnet: Optional[pulumi.Input[builtins.str]] = None,
            subnet_size: Optional[pulumi.Input[builtins.int]] = None) -> 'FirewallRule':
        """
    ...
    @property
    @pulumi.getter(name="subnetSize")
    def subnet_size(self) -> pulumi.Output[builtins.int]:
        """
        The number of bits for the subnet in CIDR notation. Example: 32.
        """
        return pulumi.get(self, "subnet_size")
