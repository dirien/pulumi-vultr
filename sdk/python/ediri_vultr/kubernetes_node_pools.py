...
class _KubernetesNodePoolsState:
    def __init__(__self__, *,
                 ...
                 max_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 min_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 node_quantity: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="nodeQuantity")
    def node_quantity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of nodes in this node pool.
        """
        return pulumi.get(self, "node_quantity")
    ...
    @node_quantity.setter
    def node_quantity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "node_quantity", value)
...
class KubernetesNodePools(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoScaler")
    def auto_scaler(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable the auto scaler for the default node pool.
        """
        return pulumi.get(self, "auto_scaler")
    ...
    @property
    @pulumi.getter(name="nodeQuantity")
    def node_quantity(self) -> pulumi.Output[builtins.int]:
        """
        The number of nodes in this node pool.
        """
        return pulumi.get(self, "node_quantity")
