...
class DatabaseReplicaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mysql_sql_modes: A list of SQL modes currently configured for the managed database read replica (MySQL engine types only).
        :param pulumi.Input[builtins.int] plan_disk: The description of the disk(s) on the managed database read replica.
        :param pulumi.Input[builtins.str] public_host: The public hostname assigned to the managed database read replica (VPC-attached only).
        :param pulumi.Input[builtins.str] tag: The tag to assign to the managed database read replica.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_ips: A list of allowed IP addresses for the managed database read replica.
        """
...
class _DatabaseReplicaState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] maintenance_dow: The preferred maintenance day of week for the managed database read replica.
        :param pulumi.Input[builtins.str] maintenance_time: The preferred maintenance time for the managed database read replica.
        :param pulumi.Input[builtins.int] mysql_long_query_time: The configuration value for the long query time (in seconds) on the managed database read replica (MySQL engine types only).
        :param pulumi.Input[builtins.bool] mysql_require_primary_key: The configuration value for whether primary keys are required on the managed database read replica (MySQL engine types only).
        :param pulumi.Input[builtins.bool] mysql_slow_query_log: The configuration value for slow query logging on the managed database read replica (MySQL engine types only).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mysql_sql_modes: A list of SQL modes currently configured for the managed database read replica (MySQL engine types only).
        :param pulumi.Input[builtins.str] password: The password for the managed database read replica's primary admin user.
        :param pulumi.Input[builtins.str] plan: The managed database read replica's plan ID.
        :param pulumi.Input[builtins.int] plan_disk: The description of the disk(s) on the managed database read replica.
        :param pulumi.Input[builtins.int] plan_ram: The amount of memory available on the managed database read replica in MB.
        :param pulumi.Input[builtins.int] plan_replicas: The number of standby nodes available on the managed database read replica.
        :param pulumi.Input[builtins.int] plan_vcpus: The number of virtual CPUs available on the managed database read replica.
        :param pulumi.Input[builtins.str] port: The connection port for the managed database read replica.
        :param pulumi.Input[builtins.str] public_host: The public hostname assigned to the managed database read replica (VPC-attached only).
        :param pulumi.Input[builtins.str] region: The ID of the region that the managed database read replica is to be created in. [See List Regions](https://www.vultr.com/api/#operation/list-regions)
        :param pulumi.Input[builtins.str] status: The current status of the managed database read replica (poweroff, rebuilding, rebalancing, configuring, running).
        :param pulumi.Input[builtins.str] tag: The tag to assign to the managed database read replica.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_ips: A list of allowed IP addresses for the managed database read replica.
...
class DatabaseReplica(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trusted_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseReplica':
        """
    ...
    @property
    @pulumi.getter(name="clusterTimeZone")
    def cluster_time_zone(self) -> pulumi.Output[builtins.str]:
        """
        The configured time zone for the managed database read replica in TZ database format.
        """
        return pulumi.get(self, "cluster_time_zone")
    ...
    @property
    @pulumi.getter(name="databaseEngine")
    def database_engine(self) -> pulumi.Output[builtins.str]:
        """
        The database engine of the managed database read replica.
        """
        return pulumi.get(self, "database_engine")
    ...
    @property
    @pulumi.getter(name="databaseEngineVersion")
    def database_engine_version(self) -> pulumi.Output[builtins.str]:
        """
        The database engine version of the managed database read replica.
        """
        return pulumi.get(self, "database_engine_version")
    ...
    @property
    @pulumi.getter
    def dbname(self) -> pulumi.Output[builtins.str]:
        """
        The managed database read replica's default logical database.
        """
        return pulumi.get(self, "dbname")
    ...
    @property
    @pulumi.getter(name="latestBackup")
    def latest_backup(self) -> pulumi.Output[builtins.str]:
        """
        The date of the latest backup available on the managed database read replica.
        """
        return pulumi.get(self, "latest_backup")
    ...
    @property
    @pulumi.getter(name="mysqlLongQueryTime")
    def mysql_long_query_time(self) -> pulumi.Output[builtins.int]:
        """
        The configuration value for the long query time (in seconds) on the managed database read replica (MySQL engine types only).
        """
        return pulumi.get(self, "mysql_long_query_time")
    ...
    @property
    @pulumi.getter(name="mysqlRequirePrimaryKey")
    def mysql_require_primary_key(self) -> pulumi.Output[builtins.bool]:
        """
        The configuration value for whether primary keys are required on the managed database read replica (MySQL engine types only).
        """
        return pulumi.get(self, "mysql_require_primary_key")
    ...
    @property
    @pulumi.getter(name="mysqlSlowQueryLog")
    def mysql_slow_query_log(self) -> pulumi.Output[builtins.bool]:
        """
        The configuration value for slow query logging on the managed database read replica (MySQL engine types only).
        """
        return pulumi.get(self, "mysql_slow_query_log")
    ...
    @property
    @pulumi.getter(name="mysqlSqlModes")
    def mysql_sql_modes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of SQL modes currently configured for the managed database read replica (MySQL engine types only).
        """
        return pulumi.get(self, "mysql_sql_modes")
    ...
    @property
    @pulumi.getter(name="planDisk")
    def plan_disk(self) -> pulumi.Output[builtins.int]:
        """
        The description of the disk(s) on the managed database read replica.
        """
        return pulumi.get(self, "plan_disk")
    ...
    @property
    @pulumi.getter(name="planRam")
    def plan_ram(self) -> pulumi.Output[builtins.int]:
        """
        The amount of memory available on the managed database read replica in MB.
        """
        return pulumi.get(self, "plan_ram")
    ...
    @property
    @pulumi.getter(name="planReplicas")
    def plan_replicas(self) -> pulumi.Output[builtins.int]:
        """
        The number of standby nodes available on the managed database read replica.
        """
        return pulumi.get(self, "plan_replicas")
    ...
    @property
    @pulumi.getter(name="planVcpus")
    def plan_vcpus(self) -> pulumi.Output[builtins.int]:
        """
        The number of virtual CPUs available on the managed database read replica.
        """
        return pulumi.get(self, "plan_vcpus")
    ...
    @property
    @pulumi.getter(name="publicHost")
    def public_host(self) -> pulumi.Output[builtins.str]:
        """
        The public hostname assigned to the managed database read replica (VPC-attached only).
        """
        return pulumi.get(self, "public_host")
    ...
    @property
    @pulumi.getter(name="trustedIps")
    def trusted_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of allowed IP addresses for the managed database read replica.
        """
        return pulumi.get(self, "trusted_ips")
