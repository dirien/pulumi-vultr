...
def get_dns_domain(domain: Optional[builtins.str] = None,
    ...
    :param builtins.str domain: The name you're searching for.
    """
    __args__ = dict()
...
def get_dns_domain_output(domain: Optional[pulumi.Input[builtins.str]] = None,
