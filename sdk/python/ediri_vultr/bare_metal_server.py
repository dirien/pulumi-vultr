...
class BareMetalServerArgs:
    def __init__(__self__, *,
                 ...
                 mdisk_mode: Optional[pulumi.Input[builtins.str]] = None,
                 os_id: Optional[pulumi.Input[builtins.int]] = None,
                 persistent_pxe: Optional[pulumi.Input[builtins.bool]] = None,
                 reserved_ipv4: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] plan: The ID of the plan that you want the server to subscribe to. [See List Plans](https://www.vultr.com/api/#tag/plans)
        :param pulumi.Input[builtins.str] region: The ID of the region that the server is to be created in. [See List Regions](https://www.vultr.com/api/#operation/list-regions)
        ...
        :param pulumi.Input[builtins.str] reserved_ipv4: The ID of the floating IP to use as the main IP of this server. [See Reserved IPs](https://www.vultr.com/api/#operation/list-reserved-ips)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the servier.
        ...
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID to use when creating the server.
        """
    ...
    def mdisk_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "mdisk_mode")

    @mdisk_mode.setter
    def mdisk_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def persistent_pxe(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "persistent_pxe")

    @persistent_pxe.setter
    def persistent_pxe(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "persistent_pxe", value)

    @property
    @pulumi.getter(name="reservedIpv4")
    def reserved_ipv4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reserved_ipv4(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BareMetalServerState:
    def __init__(__self__, *,
                 ...
                 image_id: Optional[pulumi.Input[builtins.str]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 mac_address: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 ram: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] app_id: The ID of the Vultr application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_variables: A map of user-supplied variable keys and values for Vultr Marketplace apps. [See List Marketplace App Variables](https://www.vultr.com/api/#tag/marketplace/operation/list-marketplace-app-variables)
        :param pulumi.Input[builtins.int] cpu_count: The number of CPUs available on the server.
        ...
        :param pulumi.Input[builtins.str] disk: The description of the disk(s) on the server.
        :param pulumi.Input[builtins.bool] enable_ipv6: Whether the server has IPv6 networking activated.
        :param pulumi.Input[builtins.str] gateway_v4: The server's IPv4 gateway.
        :param pulumi.Input[builtins.str] hostname: The hostname to assign to the server.
        :param pulumi.Input[builtins.str] image_id: The ID of the Vultr marketplace application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications) Note marketplace applications are denoted by type: `marketplace` and you must use the `image_id` not the id.
        :param pulumi.Input[builtins.str] label: A label for the server.
        :param pulumi.Input[builtins.int] mac_address: The MAC address associated with the server.
        ...
        :param pulumi.Input[builtins.int] os_id: The ID of the operating system to be installed on the server. [See List OS](https://www.vultr.com/api/#operation/list-os)
        :param pulumi.Input[builtins.str] plan: The ID of the plan that you want the server to subscribe to. [See List Plans](https://www.vultr.com/api/#tag/plans)
        :param pulumi.Input[builtins.str] ram: The amount of memory available on the server in MB.
        :param pulumi.Input[builtins.str] region: The ID of the region that the server is to be created in. [See List Regions](https://www.vultr.com/api/#operation/list-regions)
        :param pulumi.Input[builtins.str] reserved_ipv4: The ID of the floating IP to use as the main IP of this server. [See Reserved IPs](https://www.vultr.com/api/#operation/list-reserved-ips)
        :param pulumi.Input[builtins.str] script_id: The ID of the startup script you want added to the server.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the Vultr snapshot that the server will restore for the initial installation. [See List Snapshots](https://www.vultr.com/api/#operation/list-snapshots)
    ...
    def mac_address(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @mac_address.setter
    def mac_address(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def ram(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ram.setter
    def ram(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BareMetalServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            v6_network_size: Optional[pulumi.Input[builtins.int]] = None,
            vpc2_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BareMetalServer':
        """
    ...
    @property
    @pulumi.getter(name="macAddress")
    def mac_address(self) -> pulumi.Output[builtins.int]:
        """
        The MAC address associated with the server.
        """
        return pulumi.get(self, "mac_address")
    ...
    @property
    @pulumi.getter(name="mdiskMode")
    def mdisk_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "mdisk_mode")
    ...
    @property
    @pulumi.getter(name="persistentPxe")
    def persistent_pxe(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "persistent_pxe")
    ...
    @property
    @pulumi.getter
    def ram(self) -> pulumi.Output[builtins.str]:
        """
        The amount of memory available on the server in MB.
        """
        return pulumi.get(self, "ram")
    ...
    @property
    @pulumi.getter(name="reservedIpv4")
    def reserved_ipv4(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the floating IP to use as the main IP of this server. [See Reserved IPs](https://www.vultr.com/api/#operation/list-reserved-ips)
        """
        return pulumi.get(self, "reserved_ipv4")
    ...
    @property
    @pulumi.getter(name="scriptId")
    def script_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the startup script you want added to the server.
        """
        return pulumi.get(self, "script_id")
