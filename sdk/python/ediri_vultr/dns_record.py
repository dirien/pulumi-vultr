...
class DnsRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data: IP Address of the instance the domain is associated with.
        :param pulumi.Input[builtins.str] domain: Name of the DNS Domain this record will belong to.
        :param pulumi.Input[builtins.str] type: Type of record.
        :param pulumi.Input[builtins.str] name: Name (subdomain) for this record.
        :param pulumi.Input[builtins.int] priority: Priority of this record (only required for MX and SRV).
        :param pulumi.Input[builtins.int] ttl: The time to live of this record.
        """
...
class DnsRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'DnsRecord':
        """
