...
class DatabaseQuotaArgs:
    def __init__(__self__, *,
                 ...
                 consumer_byte_rate: pulumi.Input[builtins.int],
                 database_id: pulumi.Input[builtins.str],
                 producer_byte_rate: pulumi.Input[builtins.int],
                 request_percentage: pulumi.Input[builtins.int],
                 user: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DatabaseQuota resource.
        :param pulumi.Input[builtins.str] client_id: The client ID for the new database quota.
        :param pulumi.Input[builtins.int] consumer_byte_rate: The consumer byte rate for the new managed database quota.
        :param pulumi.Input[builtins.str] database_id: The managed database ID you want to attach this quota to.
        :param pulumi.Input[builtins.int] producer_byte_rate: The producer byte rate for the new managed database quota.
        :param pulumi.Input[builtins.int] request_percentage: The CPU request percentage for the new managed database quota.
        :param pulumi.Input[builtins.str] user: The user for the new managed database quota.
        """
    ...
    def consumer_byte_rate(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def consumer_byte_rate(self, value: pulumi.Input[builtins.int]):
    ...
    def producer_byte_rate(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def producer_byte_rate(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "producer_byte_rate", value)

    @property
    @pulumi.getter(name="requestPercentage")
    def request_percentage(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def request_percentage(self, value: pulumi.Input[builtins.int]):
...
class _DatabaseQuotaState:
    def __init__(__self__, *,
                 ...
                 request_percentage: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="requestPercentage")
    def request_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The CPU request percentage for the new managed database quota.
        """
        return pulumi.get(self, "request_percentage")
    ...
    @request_percentage.setter
    def request_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "request_percentage", value)
...
class DatabaseQuota(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            producer_byte_rate: Optional[pulumi.Input[builtins.int]] = None,
            request_percentage: Optional[pulumi.Input[builtins.int]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseQuota':
        """
    ...
    @property
    @pulumi.getter(name="consumerByteRate")
    def consumer_byte_rate(self) -> pulumi.Output[builtins.int]:
        """
        The consumer byte rate for the new managed database quota.
        """
        return pulumi.get(self, "consumer_byte_rate")
    ...
    @property
    @pulumi.getter(name="producerByteRate")
    def producer_byte_rate(self) -> pulumi.Output[builtins.int]:
        """
        The producer byte rate for the new managed database quota.
        """
        return pulumi.get(self, "producer_byte_rate")
    ...
    @property
    @pulumi.getter(name="requestPercentage")
    def request_percentage(self) -> pulumi.Output[builtins.int]:
        """
        The CPU request percentage for the new managed database quota.
        """
        return pulumi.get(self, "request_percentage")
