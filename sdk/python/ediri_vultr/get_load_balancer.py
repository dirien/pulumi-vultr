...
class GetLoadBalancerResult:
    ...
    def balancing_algorithm(self) -> builtins.str:
        """
    ...
    def firewall_rules(self) -> Sequence[Mapping[str, builtins.str]]:
        return pulumi.get(self, "firewall_rules")

    @property
    @pulumi.getter(name="forwardingRules")
    def forwarding_rules(self) -> Sequence[Mapping[str, builtins.str]]:
        """
    ...
    def has_ssl(self) -> builtins.bool:
        """
    ...
    def health_check(self) -> Mapping[str, builtins.str]:
        """
    ...
    def proxy_protocol(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def ssl(self) -> Mapping[str, builtins.str]:
...
def get_load_balancer(filters: Optional[Sequence[Union['GetLoadBalancerFilterArgs', 'GetLoadBalancerFilterArgsDict']]] = None,
                      proxy_protocol: Optional[builtins.bool] = None,
    ...
    :param builtins.bool proxy_protocol: Boolean value that indicates if Proxy Protocol is enabled.
    """
    __args__ = dict()
...
def get_load_balancer_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetLoadBalancerFilterArgs', 'GetLoadBalancerFilterArgsDict']]]]] = None,
                             proxy_protocol: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
