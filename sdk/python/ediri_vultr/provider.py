...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: The API Key that allows interaction with the API
        :param pulumi.Input[builtins.int] rate_limit: Allows users to set the speed of API calls to work with the Vultr Rate Limit
        :param pulumi.Input[builtins.int] retry_limit: Allows users to set the maximum number of retries allowed for a failed API call.
        """
        if api_key is None:
