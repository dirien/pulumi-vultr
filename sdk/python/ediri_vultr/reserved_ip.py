...
class ReservedIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip_type: The type of reserved IP that you want. Either "v4" or "v6".
        :param pulumi.Input[builtins.str] region: The region ID that you want the reserved IP to be created in.
        :param pulumi.Input[builtins.str] instance_id: The VPS ID you want this reserved IP to be attached to.
        :param pulumi.Input[builtins.str] label: The label you want to give your reserved IP.
        """
...
class _ReservedIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] label: The label you want to give your reserved IP.
        :param pulumi.Input[builtins.str] region: The region ID that you want the reserved IP to be created in.
        :param pulumi.Input[builtins.str] subnet: The reserved IP's subnet.
        :param pulumi.Input[builtins.int] subnet_size: The reserved IP's subnet size.
        """
        if instance_id is not None:
            pulumi.set(__self__, "instance_id", instance_id)
...
@pulumi.type_token("vultr:index/reservedIp:ReservedIp")
class ReservedIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            subnet: Optional[pulumi.Input[builtins.str]] = None,
            subnet_size: Optional[pulumi.Input[builtins.int]] = None) -> 'ReservedIp':
        """
