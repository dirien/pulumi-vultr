...
class VpcArgs:
    def __init__(__self__, *,
                 ...
                 v4_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 v4_subnet_mask: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Vpc resource.
        :param pulumi.Input[builtins.str] region: The region ID that you want the VPC to be created in.
        :param pulumi.Input[builtins.str] description: The description you want to give your VPC.
        :param pulumi.Input[builtins.str] v4_subnet: The IPv4 subnet to be used when attaching instances to this VPC.
        :param pulumi.Input[builtins.int] v4_subnet_mask: The number of bits for the netmask in CIDR notation. Example: 32
        """
    ...
    def v4_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v4_subnet.setter
    def v4_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v4_subnet", value)

    @property
    @pulumi.getter(name="v4SubnetMask")
    def v4_subnet_mask(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def v4_subnet_mask(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VpcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] date_created: The date that the VPC was added to your Vultr account.
        :param pulumi.Input[builtins.str] description: The description you want to give your VPC.
        :param pulumi.Input[builtins.str] region: The region ID that you want the VPC to be created in.
        :param pulumi.Input[builtins.str] v4_subnet: The IPv4 subnet to be used when attaching instances to this VPC.
        :param pulumi.Input[builtins.int] v4_subnet_mask: The number of bits for the netmask in CIDR notation. Example: 32
...
@pulumi.type_token("vultr:index/vpc:Vpc")
class Vpc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            v4_subnet: Optional[pulumi.Input[builtins.str]] = None,
            v4_subnet_mask: Optional[pulumi.Input[builtins.int]] = None) -> 'Vpc':
        """
    ...
    @property
    @pulumi.getter(name="v4Subnet")
    def v4_subnet(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 subnet to be used when attaching instances to this VPC.
        """
        return pulumi.get(self, "v4_subnet")
    ...
    @property
    @pulumi.getter(name="v4SubnetMask")
    def v4_subnet_mask(self) -> pulumi.Output[builtins.int]:
        """
        The number of bits for the netmask in CIDR notation. Example: 32
        """
        return pulumi.get(self, "v4_subnet_mask")
