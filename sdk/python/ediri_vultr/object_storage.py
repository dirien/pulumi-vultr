...
class ObjectStorageArgs:
    def __init__(__self__, *,
                 ...
                 tier_id: pulumi.Input[builtins.int],
                 label: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ObjectStorage resource.
        :param pulumi.Input[builtins.int] cluster_id: The ID of the region that you want the object storage to be deployed in.
        :param pulumi.Input[builtins.int] tier_id: The ID of the tier to deploy the storage under.
        :param pulumi.Input[builtins.str] label: The description you want to give your object storage.
        """
    ...
    def tier_id(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @tier_id.setter
    def tier_id(self, value: pulumi.Input[builtins.int]):
...
class _ObjectStorageState:
    def __init__(__self__, *,
                 ...
                 s3_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 s3_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tier_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering ObjectStorage resources.
        :param pulumi.Input[builtins.int] cluster_id: The ID of the region that you want the object storage to be deployed in.
        :param pulumi.Input[builtins.str] date_created: Date of creation for the object storage subscription.
        :param pulumi.Input[builtins.str] label: The description you want to give your object storage.
        :param pulumi.Input[builtins.str] location: The location which this subscription resides in.
        :param pulumi.Input[builtins.str] region: The region ID of the object storage subscription.
        :param pulumi.Input[builtins.str] s3_access_key: Your access key.
        :param pulumi.Input[builtins.str] s3_hostname: The hostname for this subscription.
        :param pulumi.Input[builtins.str] s3_secret_key: Your secret key.
        :param pulumi.Input[builtins.str] status: Current status of this object storage subscription.
        :param pulumi.Input[builtins.int] tier_id: The ID of the tier to deploy the storage under.
        """
    ...
    def s3_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @s3_hostname.setter
    def s3_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="tierId")
    def tier_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The ID of the tier to deploy the storage under.
        """
        return pulumi.get(self, "tier_id")
    ...
    @tier_id.setter
    def tier_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "tier_id", value)
...
class ObjectStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            s3_secret_key: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tier_id: Optional[pulumi.Input[builtins.int]] = None) -> 'ObjectStorage':
        """
    ...
    @property
    @pulumi.getter(name="s3AccessKey")
    def s3_access_key(self) -> pulumi.Output[builtins.str]:
        """
        Your access key.
        """
        return pulumi.get(self, "s3_access_key")
    ...
    @property
    @pulumi.getter(name="s3Hostname")
    def s3_hostname(self) -> pulumi.Output[builtins.str]:
        """
        The hostname for this subscription.
        """
        return pulumi.get(self, "s3_hostname")
    ...
    @property
    @pulumi.getter(name="s3SecretKey")
    def s3_secret_key(self) -> pulumi.Output[builtins.str]:
        """
        Your secret key.
        """
        return pulumi.get(self, "s3_secret_key")
    ...
    @property
    @pulumi.getter(name="tierId")
    def tier_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the tier to deploy the storage under.
        """
        return pulumi.get(self, "tier_id")
