...
class Vpc2Args:
    def __init__(__self__, *,
                 ...
                 ip_block: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region: The region ID that you want the VPC 2.0 to be created in.
        :param pulumi.Input[builtins.str] description: The description you want to give your VPC 2.0.
        :param pulumi.Input[builtins.str] ip_block: The IPv4 subnet to be used when attaching instances to this VPC 2.0.
        :param pulumi.Input[builtins.str] ip_type: Accepted values: `v4`.
        :param pulumi.Input[builtins.int] prefix_length: The number of bits for the netmask in CIDR notation. Example: 32
        """
    ...
    def ip_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ip_block.setter
    def ip_block(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _Vpc2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] date_created: The date that the VPC 2.0 was added to your Vultr account.
        :param pulumi.Input[builtins.str] description: The description you want to give your VPC 2.0.
        :param pulumi.Input[builtins.str] ip_block: The IPv4 subnet to be used when attaching instances to this VPC 2.0.
        :param pulumi.Input[builtins.str] ip_type: Accepted values: `v4`.
        :param pulumi.Input[builtins.int] prefix_length: The number of bits for the netmask in CIDR notation. Example: 32
...
@pulumi.type_token("vultr:index/vpc2:Vpc2")
class Vpc2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_type: Optional[pulumi.Input[builtins.str]] = None,
            prefix_length: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'Vpc2':
        """
    ...
    @property
    @pulumi.getter(name="ipBlock")
    def ip_block(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 subnet to be used when attaching instances to this VPC 2.0.
        """
        return pulumi.get(self, "ip_block")
