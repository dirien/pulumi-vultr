...
class ReverseIpv6Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the server you want to set an IPv6
               reverse DNS record for.
        :param pulumi.Input[builtins.str] ip: The IPv6 address used in the reverse DNS record.
        :param pulumi.Input[builtins.str] reverse: The hostname used in the IPv6 reverse DNS record.
        """
...
class ReverseIpv6(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            ip: Optional[pulumi.Input[builtins.str]] = None,
            reverse: Optional[pulumi.Input[builtins.str]] = None) -> 'ReverseIpv6':
        """
