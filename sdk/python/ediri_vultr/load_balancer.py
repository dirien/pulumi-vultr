...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 balancing_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 proxy_protocol: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] region: The region your load balancer is deployed in.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attached_instances: Array of instances that are currently attached to the load balancer.
        :param pulumi.Input[builtins.str] balancing_algorithm: The balancing algorithm for your load balancer. Options are `roundrobin` or `leastconn`. Default value is `roundrobin`
        :param pulumi.Input[builtins.str] cookie_name: Name for your given sticky session.
        ...
        :param pulumi.Input[builtins.str] label: The load balancer's label.
        :param pulumi.Input[builtins.bool] proxy_protocol: Boolean value that indicates if Proxy Protocol is enabled.
        ...
        :param pulumi.Input[builtins.bool] ssl_redirect: Boolean value that indicates if HTTP calls will be redirected to HTTPS.
        :param pulumi.Input[builtins.str] vpc: A VPC ID that the load balancer should be attached to.
        """
    ...
    def balancing_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def balancing_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def proxy_protocol(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def proxy_protocol(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
                 ...
                 has_ssl: Optional[pulumi.Input[builtins.bool]] = None,
                 health_check: Optional[pulumi.Input['LoadBalancerHealthCheckArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerFirewallRuleArgs']]] firewall_rules: Defines the firewall rules for a load balancer.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerForwardingRuleArgs']]] forwarding_rules: List of forwarding rules for a load balancer. The configuration of a `forwarding_rules` is listened below.
        :param pulumi.Input[builtins.bool] has_ssl: Boolean value that indicates if SSL is enabled.
        :param pulumi.Input['LoadBalancerHealthCheckArgs'] health_check: A block that defines the way load balancers should check for health. The configuration of a `health_check` is listed below.
        :param pulumi.Input[builtins.str] ipv4: IPv4 address for your load balancer.
        :param pulumi.Input[builtins.str] ipv6: IPv6 address for your load balancer.
        :param pulumi.Input[builtins.str] label: The load balancer's label.
        :param pulumi.Input[builtins.bool] proxy_protocol: Boolean value that indicates if Proxy Protocol is enabled.
        :param pulumi.Input[builtins.str] region: The region your load balancer is deployed in.
        :param pulumi.Input['LoadBalancerSslArgs'] ssl: A block that supplies your ssl configuration to be used with HTTPS. The configuration of a `ssl` is listed below.
        :param pulumi.Input[builtins.bool] ssl_redirect: Boolean value that indicates if HTTP calls will be redirected to HTTPS.
        :param pulumi.Input[builtins.str] status: Current status for the load balancer
        :param pulumi.Input[builtins.str] vpc: A VPC ID that the load balancer should be attached to.
        """
        if attached_instances is not None:
            pulumi.set(__self__, "attached_instances", attached_instances)
    ...
    def has_ssl(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @has_ssl.setter
    def has_ssl(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("vultr:index/loadBalancer:LoadBalancer")
class LoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_redirect: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vpc: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancer':
        """
    ...
    @property
    @pulumi.getter(name="attachedInstances")
    def attached_instances(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Array of instances that are currently attached to the load balancer.
        """
        return pulumi.get(self, "attached_instances")
    ...
    @property
    @pulumi.getter(name="balancingAlgorithm")
    def balancing_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        The balancing algorithm for your load balancer. Options are `roundrobin` or `leastconn`. Default value is `roundrobin`
        """
        return pulumi.get(self, "balancing_algorithm")
    ...
    @property
    @pulumi.getter(name="cookieName")
    def cookie_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name for your given sticky session.
        """
        return pulumi.get(self, "cookie_name")
    ...
    @property
    @pulumi.getter(name="hasSsl")
    def has_ssl(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean value that indicates if SSL is enabled.
        """
        return pulumi.get(self, "has_ssl")
    ...
    @property
    @pulumi.getter(name="proxyProtocol")
    def proxy_protocol(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that indicates if Proxy Protocol is enabled.
        """
        return pulumi.get(self, "proxy_protocol")
    ...
    @property
    @pulumi.getter(name="sslRedirect")
    def ssl_redirect(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that indicates if HTTP calls will be redirected to HTTPS.
        """
        return pulumi.get(self, "ssl_redirect")
