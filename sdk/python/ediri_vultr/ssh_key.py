...
class SSHKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ssh_key: The public SSH key.
        :param pulumi.Input[builtins.str] name: The name/label of the SSH key.
        """
...
class _SSHKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] date_created: The date the SSH key was added to your Vultr account.
        :param pulumi.Input[builtins.str] name: The name/label of the SSH key.
        :param pulumi.Input[builtins.str] ssh_key: The public SSH key.
        """
