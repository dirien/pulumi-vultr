...
class BlockStorageArgs:
    def __init__(__self__, *,
                 ...
                 attached_to_instance: Optional[pulumi.Input[builtins.str]] = None,
                 block_type: Optional[pulumi.Input[builtins.str]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 live: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a BlockStorage resource.
        :param pulumi.Input[builtins.str] region: Region in which this block storage will reside in. (Currently only NJ/NY supported region "ewr")
        :param pulumi.Input[builtins.int] size_gb: The size of the given block storage.
        :param pulumi.Input[builtins.str] attached_to_instance: VPS ID that you want to have this block storage attached to.
        :param pulumi.Input[builtins.str] block_type: Determines on the type of block storage volume that will be created. Soon to become a required parameter. Options are `high_perf` or `storage_opt`.
        :param pulumi.Input[builtins.str] label: Label that is given to your block storage.
        :param pulumi.Input[builtins.bool] live: Boolean value that will allow attachment of the volume to an instance without a restart. Default is false.
        """
    ...
    def attached_to_instance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attached_to_instance(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "attached_to_instance", value)

    @property
    @pulumi.getter(name="blockType")
    def block_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @block_type.setter
    def block_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def live(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @live.setter
    def live(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BlockStorageState:
    def __init__(__self__, *,
                 ...
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 live: Optional[pulumi.Input[builtins.bool]] = None,
                 mount_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] attached_to_instance: VPS ID that you want to have this block storage attached to.
        :param pulumi.Input[builtins.str] block_type: Determines on the type of block storage volume that will be created. Soon to become a required parameter. Options are `high_perf` or `storage_opt`.
        :param pulumi.Input[builtins.float] cost: The monthly cost of this block storage.
        :param pulumi.Input[builtins.str] date_created: The date this block storage was created.
        :param pulumi.Input[builtins.str] label: Label that is given to your block storage.
        :param pulumi.Input[builtins.bool] live: Boolean value that will allow attachment of the volume to an instance without a restart. Default is false.
        :param pulumi.Input[builtins.str] mount_id: An ID associated with the instance, when mounted the ID can be found in /dev/disk/by-id prefixed with virtio.
        :param pulumi.Input[builtins.str] region: Region in which this block storage will reside in. (Currently only NJ/NY supported region "ewr")
        :param pulumi.Input[builtins.int] size_gb: The size of the given block storage.
        :param pulumi.Input[builtins.str] status: Current status of your block storage.
        """
        if attached_to_instance is not None:
            pulumi.set(__self__, "attached_to_instance", attached_to_instance)
        if block_type is not None:
    ...
    def mount_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mount_id.setter
    def mount_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BlockStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            size_gb: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'BlockStorage':
        """
    ...
    @property
    @pulumi.getter(name="attachedToInstance")
    def attached_to_instance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        VPS ID that you want to have this block storage attached to.
        """
        return pulumi.get(self, "attached_to_instance")
    ...
    @property
    @pulumi.getter(name="blockType")
    def block_type(self) -> pulumi.Output[builtins.str]:
        """
        Determines on the type of block storage volume that will be created. Soon to become a required parameter. Options are `high_perf` or `storage_opt`.
        """
        return pulumi.get(self, "block_type")
    ...
    @property
    @pulumi.getter
    def live(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that will allow attachment of the volume to an instance without a restart. Default is false.
        """
        return pulumi.get(self, "live")
    ...
    @property
    @pulumi.getter(name="mountId")
    def mount_id(self) -> pulumi.Output[builtins.str]:
        """
        An ID associated with the instance, when mounted the ID can be found in /dev/disk/by-id prefixed with virtio.
        """
        return pulumi.get(self, "mount_id")
