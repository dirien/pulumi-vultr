...
class InstanceIpv4Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance to be assigned the IPv4 address.
        :param pulumi.Input[builtins.bool] reboot: Default true. Determines whether or not the server is rebooted after adding the IPv4 address.
        """
...
class _InstanceIpv4State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the instance to be assigned the IPv4 address.
        :param pulumi.Input[builtins.str] ip: The IPv4 address in canonical format.
        :param pulumi.Input[builtins.str] netmask: The IPv4 netmask in dot-decimal notation.
        :param pulumi.Input[builtins.bool] reboot: Default true. Determines whether or not the server is rebooted after adding the IPv4 address.
        :param pulumi.Input[builtins.str] reverse: The reverse DNS information for this IP address.
        """
...
@pulumi.type_token("vultr:index/instanceIpv4:InstanceIpv4")
class InstanceIpv4(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            netmask: Optional[pulumi.Input[builtins.str]] = None,
            reboot: Optional[pulumi.Input[builtins.bool]] = None,
            reverse: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceIpv4':
        """
    ...
    @property
    @pulumi.getter
    def reboot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Default true. Determines whether or not the server is rebooted after adding the IPv4 address.
        """
        return pulumi.get(self, "reboot")
