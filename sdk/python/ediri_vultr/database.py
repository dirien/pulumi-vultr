...
class DatabaseArgs:
    def __init__(__self__, *,
                 database_engine: pulumi.Input[builtins.str],
                 database_engine_version: pulumi.Input[builtins.str],
                 ...
                 plan_brokers: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] plan_brokers: The number of brokers available on the managed database (Kafka engine types only).
    ...
    def database_engine(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def database_engine(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "database_engine", value)

    @property
    @pulumi.getter(name="databaseEngineVersion")
    def database_engine_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def database_engine_version(self, value: pulumi.Input[builtins.str]):
    ...
    def plan_brokers(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @plan_brokers.setter
    def plan_brokers(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def sasl_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sasl_port.setter
    def sasl_port(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trusted_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Database':
        """
    ...
    @property
    @pulumi.getter(name="mysqlRequirePrimaryKey")
    def mysql_require_primary_key(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The configuration value for whether primary keys are required on the managed database (MySQL engine types only).
        """
        return pulumi.get(self, "mysql_require_primary_key")
    ...
    @property
    @pulumi.getter(name="mysqlSqlModes")
    def mysql_sql_modes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of SQL modes to configure for the managed database (MySQL engine types only - `ALLOW_INVALID_DATES`, `ANSI`, `ANSI_QUOTES`, `ERROR_FOR_DIVISION_BY_ZERO`, `HIGH_NOT_PRECEDENCE`, `IGNORE_SPACE`, `NO_AUTO_VALUE_ON_ZERO`, `NO_DIR_IN_CREATE`, `NO_ENGINE_SUBSTITUTION`, `NO_UNSIGNED_SUBTRACTION`, `NO_ZERO_DATE`, `NO_ZERO_IN_DATE`, `ONLY_FULL_GROUP_BY`, `PIPES_AS_CONCAT`, `REAL_AS_FLOAT`, `STRICT_ALL_TABLES`, `STRICT_TRANS_TABLES`, `TIME_TRUNCATE_FRACTIONAL`, `TRADITIONAL`).
        """
        return pulumi.get(self, "mysql_sql_modes")
    ...
    @property
    @pulumi.getter(name="planBrokers")
    def plan_brokers(self) -> pulumi.Output[builtins.int]:
        """
        The number of brokers available on the managed database (Kafka engine types only).
        """
        return pulumi.get(self, "plan_brokers")
    ...
    @property
    @pulumi.getter(name="saslPort")
    def sasl_port(self) -> pulumi.Output[builtins.str]:
        """
        The SASL connection port for the managed database (Kafka engine types only).
        """
        return pulumi.get(self, "sasl_port")
    ...
    @property
    @pulumi.getter(name="trustedIps")
    def trusted_ips(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of allowed IP addresses for the managed database.
        """
        return pulumi.get(self, "trusted_ips")
