...
class DatabaseDbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_id: The managed database ID you want to attach this logical DB to.
        :param pulumi.Input[builtins.str] name: The name of the new managed database logical DB.
        """
