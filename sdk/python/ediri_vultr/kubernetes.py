...
class KubernetesArgs:
    def __init__(__self__, *,
                 ...
                 enable_firewall: Optional[pulumi.Input[builtins.bool]] = None,
                 ha_controlplanes: Optional[pulumi.Input[builtins.bool]] = None,
                 node_pools: Optional[pulumi.Input['KubernetesNodePoolsArgs']] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Kubernetes resource.
        :param pulumi.Input[builtins.str] label: The VKE clusters label.
        :param pulumi.Input[builtins.str] region: The region your VKE cluster will be deployed in.
        :param pulumi.Input[builtins.str] version: The version your VKE cluster you want deployed. [See Available Version](https://www.vultr.com/api/#operation/get-kubernetes-versions)
        :param pulumi.Input[builtins.bool] enable_firewall: Boolean indicating if the cluster should be created with a managed firewall.
        :param pulumi.Input[builtins.bool] ha_controlplanes: Boolean indicating if the cluster should be created with multiple, highly available controlplanes.
        :param pulumi.Input['KubernetesNodePoolsArgs'] node_pools: Contains the default node pool that was deployed.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC to use when creating the cluster. If not provided a new VPC will be created instead.
        """
    ...
    def enable_firewall(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_firewall(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_firewall", value)

    @property
    @pulumi.getter(name="haControlplanes")
    def ha_controlplanes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ha_controlplanes(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KubernetesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_certificate: The base64 encoded public certificate used by clients to access the cluster.
        :param pulumi.Input[builtins.str] client_key: The base64 encoded private key used by clients to access the cluster.
        :param pulumi.Input[builtins.str] cluster_ca_certificate: The base64 encoded public certificate for the cluster's certificate authority.
        :param pulumi.Input[builtins.str] cluster_subnet: IP range that your pods will run on in this cluster.
        :param pulumi.Input[builtins.str] date_created: Date node was created.
        :param pulumi.Input[builtins.bool] enable_firewall: Boolean indicating if the cluster should be created with a managed firewall.
        :param pulumi.Input[builtins.str] endpoint: Domain for your Kubernetes clusters control plane.
        :param pulumi.Input[builtins.str] firewall_group_id: The ID of the firewall group managed by this cluster.
        :param pulumi.Input[builtins.bool] ha_controlplanes: Boolean indicating if the cluster should be created with multiple, highly available controlplanes.
        :param pulumi.Input[builtins.str] ip: IP address of VKE cluster control plane.
        :param pulumi.Input[builtins.str] kube_config: Base64 encoded Kubeconfig for this VKE cluster.
        :param pulumi.Input[builtins.str] label: The VKE clusters label.
        :param pulumi.Input['KubernetesNodePoolsArgs'] node_pools: Contains the default node pool that was deployed.
        :param pulumi.Input[builtins.str] region: The region your VKE cluster will be deployed in.
        :param pulumi.Input[builtins.str] service_subnet: IP range that services will run on this cluster.
...
class Kubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Kubernetes':
        """
    ...
    @property
    @pulumi.getter(name="enableFirewall")
    def enable_firewall(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean indicating if the cluster should be created with a managed firewall.
        """
        return pulumi.get(self, "enable_firewall")
    ...
    @property
    @pulumi.getter(name="haControlplanes")
    def ha_controlplanes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean indicating if the cluster should be created with multiple, highly available controlplanes.
        """
        return pulumi.get(self, "ha_controlplanes")
