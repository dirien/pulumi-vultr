...
class FirewallGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the firewall group.
        """
...
class _FirewallGroupState:
    def __init__(__self__, *,
                 ...
                 max_rule_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] date_created: The date the firewall group was created.
        :param pulumi.Input[builtins.str] date_modified: The date the firewall group was modified.
        :param pulumi.Input[builtins.str] description: Description of the firewall group.
        :param pulumi.Input[builtins.int] instance_count: The number of instances that are currently using this firewall group.
        :param pulumi.Input[builtins.int] max_rule_count: The number of max firewall rules this group can have.
        :param pulumi.Input[builtins.int] rule_count: The number of firewall rules this group currently has.
        """
    ...
    def max_rule_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_rule_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FirewallGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_count: Optional[pulumi.Input[builtins.int]] = None,
            max_rule_count: Optional[pulumi.Input[builtins.int]] = None,
            rule_count: Optional[pulumi.Input[builtins.int]] = None) -> 'FirewallGroup':
        """
    ...
    @property
    @pulumi.getter(name="maxRuleCount")
    def max_rule_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of max firewall rules this group can have.
        """
        return pulumi.get(self, "max_rule_count")
