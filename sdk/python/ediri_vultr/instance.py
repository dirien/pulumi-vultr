...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 activation_email: Optional[pulumi.Input[builtins.bool]] = None,
                 app_id: Optional[pulumi.Input[builtins.int]] = None,
                 app_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 backups: Optional[pulumi.Input[builtins.str]] = None,
                 backups_schedule: Optional[pulumi.Input['InstanceBackupsScheduleArgs']] = None,
                 ddos_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_public_ipv4: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_ipv6: Optional[pulumi.Input[builtins.bool]] = None,
                 firewall_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 image_id: Optional[pulumi.Input[builtins.str]] = None,
                 ipxe_chain_url: Optional[pulumi.Input[builtins.str]] = None,
                 iso_id: Optional[pulumi.Input[builtins.str]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 os_id: Optional[pulumi.Input[builtins.int]] = None,
                 reserved_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 user_scheme: Optional[pulumi.Input[builtins.str]] = None,
                 vpc2_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vpc_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Instance resource.
        :param pulumi.Input[builtins.str] plan: The ID of the plan that you want the instance to subscribe to. [See List Plans](https://www.vultr.com/api/#tag/plans)
        :param pulumi.Input[builtins.str] region: The ID of the region that the instance is to be created in. [See List Regions](https://www.vultr.com/api/#operation/list-regions)
        :param pulumi.Input[builtins.bool] activation_email: Whether an activation email will be sent when the server is ready.
        :param pulumi.Input[builtins.int] app_id: The ID of the Vultr application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_variables: A map of user-supplied variable keys and values for Vultr Marketplace apps. [See List Marketplace App Variables](https://www.vultr.com/api/#tag/marketplace/operation/list-marketplace-app-variables)
        :param pulumi.Input[builtins.str] backups: Whether automatic backups will be enabled for this server (these have an extra charge associated with them). Values can be enabled or disabled.
        ...
        :param pulumi.Input[builtins.bool] ddos_protection: Whether DDOS protection will be enabled on the server (there is an additional charge for this).
        :param pulumi.Input[builtins.bool] disable_public_ipv4: Whether the server has a public IPv4 address assigned (only possible with `enable_ipv6` set to `true`)
        :param pulumi.Input[builtins.bool] enable_ipv6: Whether the server has IPv6 networking activated.
        :param pulumi.Input[builtins.str] firewall_group_id: The ID of the firewall group to assign to the server.
        :param pulumi.Input[builtins.str] hostname: The hostname to assign to the server.
        :param pulumi.Input[builtins.str] image_id: The ID of the Vultr marketplace application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications) Note marketplace applications are denoted by type: `marketplace` and you must use the `image_id` not the id.
        :param pulumi.Input[builtins.str] ipxe_chain_url: The URL location of the iPXE chainloader.
        :param pulumi.Input[builtins.str] iso_id: The ID of the ISO file to be installed on the server. [See List ISO](https://www.vultr.com/api/#operation/list-isos)
        :param pulumi.Input[builtins.str] label: A label for the server.
        :param pulumi.Input[builtins.int] os_id: The ID of the operating system to be installed on the server. [See List OS](https://www.vultr.com/api/#operation/list-os)
        :param pulumi.Input[builtins.str] reserved_ip_id: ID of the floating IP to use as the main IP of this server.
        :param pulumi.Input[builtins.str] script_id: The ID of the startup script you want added to the server.
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the Vultr snapshot that the server will restore for the initial installation. [See List Snapshots](https://www.vultr.com/api/#operation/list-snapshots)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_key_ids: A list of SSH key IDs to apply to the server on install (only valid for Linux/FreeBSD).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the instance.
        :param pulumi.Input[builtins.str] user_data: Generic data store, which some provisioning tools and cloud operating systems use as a configuration file. It is generally consumed only once after an instance has been launched, but individual needs may vary.
        :param pulumi.Input[builtins.str] user_scheme: The scheme used for the default user. Possible values are `root` or `limited` (linux servers only).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc2_ids: A list of VPC 2.0 IDs to be attached to the server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ids: A list of VPC IDs to be attached to the server.
        """
        ...
        if ipxe_chain_url is not None:
            pulumi.set(__self__, "ipxe_chain_url", ipxe_chain_url)
        ...
        if vpc2_ids is not None:
            warnings.warn("""VPC2 is deprecated and will not be supported in a future release.  Use VPC instead""", DeprecationWarning)
            pulumi.log.warn("""vpc2_ids is deprecated: VPC2 is deprecated and will not be supported in a future release.  Use VPC instead""")
        if vpc2_ids is not None:
    ...
    def activation_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def activation_email(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def app_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def app_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "app_variables", value)

    @property
    @pulumi.getter
    def backups(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @backups.setter
    def backups(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ddos_protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ddos_protection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ddos_protection", value)

    @property
    @pulumi.getter(name="disablePublicIpv4")
    def disable_public_ipv4(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_public_ipv4(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def firewall_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def firewall_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="ipxeChainUrl")
    def ipxe_chain_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URL location of the iPXE chainloader.
        """
        return pulumi.get(self, "ipxe_chain_url")

    @ipxe_chain_url.setter
    def ipxe_chain_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipxe_chain_url", value)

    @property
    @pulumi.getter(name="isoId")
    def iso_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @iso_id.setter
    def iso_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def os_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @os_id.setter
    def os_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "os_id", value)

    @property
    @pulumi.getter(name="reservedIpId")
    def reserved_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reserved_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_scheme(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @user_scheme.setter
    def user_scheme(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_scheme", value)

    @property
    @pulumi.getter(name="vpc2Ids")
    @_utilities.deprecated("""VPC2 is deprecated and will not be supported in a future release.  Use VPC instead""")
    def vpc2_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @vpc2_ids.setter
    def vpc2_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 activation_email: Optional[pulumi.Input[builtins.bool]] = None,
                 allowed_bandwidth: Optional[pulumi.Input[builtins.int]] = None,
                 app_id: Optional[pulumi.Input[builtins.int]] = None,
                 app_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 backups: Optional[pulumi.Input[builtins.str]] = None,
                 backups_schedule: Optional[pulumi.Input['InstanceBackupsScheduleArgs']] = None,
                 ...
                 firewall_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_v4: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 image_id: Optional[pulumi.Input[builtins.str]] = None,
                 internal_ip: Optional[pulumi.Input[builtins.str]] = None,
                 ipxe_chain_url: Optional[pulumi.Input[builtins.str]] = None,
                 iso_id: Optional[pulumi.Input[builtins.str]] = None,
                 kvm: Optional[pulumi.Input[builtins.str]] = None,
                 label: Optional[pulumi.Input[builtins.str]] = None,
                 main_ip: Optional[pulumi.Input[builtins.str]] = None,
                 netmask_v4: Optional[pulumi.Input[builtins.str]] = None,
                 os: Optional[pulumi.Input[builtins.str]] = None,
                 os_id: Optional[pulumi.Input[builtins.int]] = None,
                 plan: Optional[pulumi.Input[builtins.str]] = None,
                 power_status: Optional[pulumi.Input[builtins.str]] = None,
                 ram: Optional[pulumi.Input[builtins.int]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 reserved_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 script_id: Optional[pulumi.Input[builtins.str]] = None,
                 server_status: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 ssh_key_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 user_data: Optional[pulumi.Input[builtins.str]] = None,
                 user_scheme: Optional[pulumi.Input[builtins.str]] = None,
                 v6_main_ip: Optional[pulumi.Input[builtins.str]] = None,
                 v6_network: Optional[pulumi.Input[builtins.str]] = None,
                 v6_network_size: Optional[pulumi.Input[builtins.int]] = None,
                 vcpu_count: Optional[pulumi.Input[builtins.int]] = None,
                 vpc2_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vpc_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering Instance resources.
        :param pulumi.Input[builtins.bool] activation_email: Whether an activation email will be sent when the server is ready.
        :param pulumi.Input[builtins.int] allowed_bandwidth: The server's allowed bandwidth usage in GB.
        :param pulumi.Input[builtins.int] app_id: The ID of the Vultr application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_variables: A map of user-supplied variable keys and values for Vultr Marketplace apps. [See List Marketplace App Variables](https://www.vultr.com/api/#tag/marketplace/operation/list-marketplace-app-variables)
        :param pulumi.Input[builtins.str] backups: Whether automatic backups will be enabled for this server (these have an extra charge associated with them). Values can be enabled or disabled.
        :param pulumi.Input['InstanceBackupsScheduleArgs'] backups_schedule: A block that defines the way backups should be scheduled. While this is an optional field if `backups` are `enabled` this field is mandatory. The configuration of a `backups_schedule` is listed below.
        :param pulumi.Input[builtins.str] date_created: The date the server was added to your Vultr account.
        :param pulumi.Input[builtins.bool] ddos_protection: Whether DDOS protection will be enabled on the server (there is an additional charge for this).
        :param pulumi.Input[builtins.str] default_password: The server's default password.
        :param pulumi.Input[builtins.bool] disable_public_ipv4: Whether the server has a public IPv4 address assigned (only possible with `enable_ipv6` set to `true`)
        :param pulumi.Input[builtins.int] disk: The description of the disk(s) on the server.
        :param pulumi.Input[builtins.bool] enable_ipv6: Whether the server has IPv6 networking activated.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] features: Array of which features are enabled.
        :param pulumi.Input[builtins.str] firewall_group_id: The ID of the firewall group to assign to the server.
        :param pulumi.Input[builtins.str] gateway_v4: The server's IPv4 gateway.
        :param pulumi.Input[builtins.str] hostname: The hostname to assign to the server.
        :param pulumi.Input[builtins.str] image_id: The ID of the Vultr marketplace application to be installed on the server. [See List Applications](https://www.vultr.com/api/#operation/list-applications) Note marketplace applications are denoted by type: `marketplace` and you must use the `image_id` not the id.
        :param pulumi.Input[builtins.str] internal_ip: The server's internal IP address.
        :param pulumi.Input[builtins.str] ipxe_chain_url: The URL location of the iPXE chainloader.
        :param pulumi.Input[builtins.str] iso_id: The ID of the ISO file to be installed on the server. [See List ISO](https://www.vultr.com/api/#operation/list-isos)
        :param pulumi.Input[builtins.str] kvm: The server's current KVM URL. This URL will change periodically. It is not advised to cache this value.
        :param pulumi.Input[builtins.str] label: A label for the server.
        :param pulumi.Input[builtins.str] main_ip: The server's main IP address.
        :param pulumi.Input[builtins.str] netmask_v4: The server's IPv4 netmask.
        :param pulumi.Input[builtins.str] os: The string description of the operating system installed on the server.
        :param pulumi.Input[builtins.int] os_id: The ID of the operating system to be installed on the server. [See List OS](https://www.vultr.com/api/#operation/list-os)
        :param pulumi.Input[builtins.str] plan: The ID of the plan that you want the instance to subscribe to. [See List Plans](https://www.vultr.com/api/#tag/plans)
        :param pulumi.Input[builtins.str] power_status: Whether the server is powered on or not.
        :param pulumi.Input[builtins.int] ram: The amount of memory available on the server in MB.
        :param pulumi.Input[builtins.str] region: The ID of the region that the instance is to be created in. [See List Regions](https://www.vultr.com/api/#operation/list-regions)
        :param pulumi.Input[builtins.str] reserved_ip_id: ID of the floating IP to use as the main IP of this server.
        :param pulumi.Input[builtins.str] script_id: The ID of the startup script you want added to the server.
        :param pulumi.Input[builtins.str] server_status: A more detailed server status (none, locked, installingbooting, isomounting, ok).
        :param pulumi.Input[builtins.str] snapshot_id: The ID of the Vultr snapshot that the server will restore for the initial installation. [See List Snapshots](https://www.vultr.com/api/#operation/list-snapshots)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_key_ids: A list of SSH key IDs to apply to the server on install (only valid for Linux/FreeBSD).
        :param pulumi.Input[builtins.str] status: The status of the server's subscription.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to apply to the instance.
        :param pulumi.Input[builtins.str] user_data: Generic data store, which some provisioning tools and cloud operating systems use as a configuration file. It is generally consumed only once after an instance has been launched, but individual needs may vary.
        :param pulumi.Input[builtins.str] user_scheme: The scheme used for the default user. Possible values are `root` or `limited` (linux servers only).
        :param pulumi.Input[builtins.str] v6_main_ip: The main IPv6 network address.
        :param pulumi.Input[builtins.str] v6_network: The IPv6 subnet.
        :param pulumi.Input[builtins.int] v6_network_size: The IPv6 network size in bits.
        :param pulumi.Input[builtins.int] vcpu_count: The number of virtual CPUs available on the server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc2_ids: A list of VPC 2.0 IDs to be attached to the server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ids: A list of VPC IDs to be attached to the server.
        """
        if activation_email is not None:
    ...
    def allowed_bandwidth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def allowed_bandwidth(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def gateway_v4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gateway_v4.setter
    def gateway_v4(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def kvm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @kvm.setter
    def kvm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def main_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @main_ip.setter
    def main_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "main_ip", value)

    @property
    @pulumi.getter(name="netmaskV4")
    def netmask_v4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @netmask_v4.setter
    def netmask_v4(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def power_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @power_status.setter
    def power_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def server_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def v6_main_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @v6_main_ip.setter
    def v6_main_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v6_main_ip", value)

    @property
    @pulumi.getter(name="v6Network")
    def v6_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IPv6 subnet.
        """
    ...
    @v6_network.setter
    def v6_network(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "v6_network", value)

    @property
    @pulumi.getter(name="v6NetworkSize")
    def v6_network_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def v6_network_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "v6_network_size", value)

    @property
    @pulumi.getter(name="vcpuCount")
    def vcpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @vcpu_count.setter
    def vcpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("vultr:index/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["ipxe_chain_url"] = ipxe_chain_url
    ...
    def get(resource_name: str,
            ...
            vcpu_count: Optional[pulumi.Input[builtins.int]] = None,
            vpc2_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vpc_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="activationEmail")
    def activation_email(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether an activation email will be sent when the server is ready.
        """
        return pulumi.get(self, "activation_email")
    ...
    @property
    @pulumi.getter(name="allowedBandwidth")
    def allowed_bandwidth(self) -> pulumi.Output[builtins.int]:
        """
        The server's allowed bandwidth usage in GB.
        """
        return pulumi.get(self, "allowed_bandwidth")
    ...
    @property
    @pulumi.getter(name="appVariables")
    def app_variables(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        A map of user-supplied variable keys and values for Vultr Marketplace apps. [See List Marketplace App Variables](https://www.vultr.com/api/#tag/marketplace/operation/list-marketplace-app-variables)
        """
        return pulumi.get(self, "app_variables")
    ...
    @property
    @pulumi.getter
    def backups(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether automatic backups will be enabled for this server (these have an extra charge associated with them). Values can be enabled or disabled.
        """
        return pulumi.get(self, "backups")
    ...
    @property
    @pulumi.getter(name="ddosProtection")
    def ddos_protection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether DDOS protection will be enabled on the server (there is an additional charge for this).
        """
        return pulumi.get(self, "ddos_protection")
    ...
    @property
    @pulumi.getter(name="defaultPassword")
    def default_password(self) -> pulumi.Output[builtins.str]:
        """
        The server's default password.
        """
        return pulumi.get(self, "default_password")
    ...
    @property
    @pulumi.getter(name="disablePublicIpv4")
    def disable_public_ipv4(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the server has a public IPv4 address assigned (only possible with `enable_ipv6` set to `true`)
        """
        return pulumi.get(self, "disable_public_ipv4")
    ...
    @property
    @pulumi.getter(name="firewallGroupId")
    def firewall_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the firewall group to assign to the server.
        """
        return pulumi.get(self, "firewall_group_id")
    ...
    @property
    @pulumi.getter(name="gatewayV4")
    def gateway_v4(self) -> pulumi.Output[builtins.str]:
        """
        The server's IPv4 gateway.
        """
        return pulumi.get(self, "gateway_v4")
    ...
    @property
    @pulumi.getter(name="ipxeChainUrl")
    def ipxe_chain_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL location of the iPXE chainloader.
        """
        return pulumi.get(self, "ipxe_chain_url")
    ...
    @property
    @pulumi.getter(name="isoId")
    def iso_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the ISO file to be installed on the server. [See List ISO](https://www.vultr.com/api/#operation/list-isos)
        """
        return pulumi.get(self, "iso_id")
    ...
    @property
    @pulumi.getter
    def kvm(self) -> pulumi.Output[builtins.str]:
        """
        The server's current KVM URL. This URL will change periodically. It is not advised to cache this value.
        """
        return pulumi.get(self, "kvm")
    ...
    @property
    @pulumi.getter(name="mainIp")
    def main_ip(self) -> pulumi.Output[builtins.str]:
        """
        The server's main IP address.
        """
        return pulumi.get(self, "main_ip")
    ...
    @property
    @pulumi.getter(name="netmaskV4")
    def netmask_v4(self) -> pulumi.Output[builtins.str]:
        """
        The server's IPv4 netmask.
        """
        return pulumi.get(self, "netmask_v4")
    ...
    @property
    @pulumi.getter(name="osId")
    def os_id(self) -> pulumi.Output[builtins.int]:
        """
        The ID of the operating system to be installed on the server. [See List OS](https://www.vultr.com/api/#operation/list-os)
        """
        return pulumi.get(self, "os_id")
    ...
    @property
    @pulumi.getter(name="powerStatus")
    def power_status(self) -> pulumi.Output[builtins.str]:
        """
        Whether the server is powered on or not.
        """
        return pulumi.get(self, "power_status")
    ...
    @property
    @pulumi.getter(name="reservedIpId")
    def reserved_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the floating IP to use as the main IP of this server.
        """
        return pulumi.get(self, "reserved_ip_id")
    ...
    @property
    @pulumi.getter(name="serverStatus")
    def server_status(self) -> pulumi.Output[builtins.str]:
        """
        A more detailed server status (none, locked, installingbooting, isomounting, ok).
        """
        return pulumi.get(self, "server_status")
    ...
    @property
    @pulumi.getter(name="userScheme")
    def user_scheme(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scheme used for the default user. Possible values are `root` or `limited` (linux servers only).
        """
        return pulumi.get(self, "user_scheme")
    ...
    @property
    @pulumi.getter(name="v6MainIp")
    def v6_main_ip(self) -> pulumi.Output[builtins.str]:
        """
        The main IPv6 network address.
        """
        return pulumi.get(self, "v6_main_ip")
    ...
    @property
    @pulumi.getter(name="v6Network")
    def v6_network(self) -> pulumi.Output[builtins.str]:
        """
        The IPv6 subnet.
        """
        return pulumi.get(self, "v6_network")
    ...
    @property
    @pulumi.getter(name="v6NetworkSize")
    def v6_network_size(self) -> pulumi.Output[builtins.int]:
        """
        The IPv6 network size in bits.
        """
        return pulumi.get(self, "v6_network_size")
    ...
    @property
    @pulumi.getter(name="vcpuCount")
    def vcpu_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of virtual CPUs available on the server.
        """
        return pulumi.get(self, "vcpu_count")
    ...
    @pulumi.getter(name="vpc2Ids")
    @_utilities.deprecated("""VPC2 is deprecated and will not be supported in a future release.  Use VPC instead""")
    def vpc2_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of VPC 2.0 IDs to be attached to the server.
        """
        return pulumi.get(self, "vpc2_ids")
