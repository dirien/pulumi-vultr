...
class DatabaseConnectionPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database: The logical database to use for the new managed database connection pool.
        :param pulumi.Input[builtins.str] database_id: The managed database ID you want to attach this connection pool to.
        :param pulumi.Input[builtins.str] mode: The mode to configure for the new managed database connection pool (`session`, `transaction`, `statement`).
        :param pulumi.Input[builtins.int] size: The size of the new managed database connection pool.
        :param pulumi.Input[builtins.str] username: The database user to use for the new managed database connection pool.
        :param pulumi.Input[builtins.str] name: The name of the new managed database connection pool.
        """
...
@pulumi.type_token("vultr:index/databaseConnectionPool:DatabaseConnectionPool")
class DatabaseConnectionPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseConnectionPool':
        """
