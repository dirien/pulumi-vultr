...
class _IsoPrivateState:
    def __init__(__self__, *,
                 ...
                 sha512sum: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def sha512sum(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sha512sum")

    @sha512sum.setter
    def sha512sum(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IsoPrivate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'IsoPrivate':
        """
    ...
    @property
    @pulumi.getter
    def sha512sum(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "sha512sum")
