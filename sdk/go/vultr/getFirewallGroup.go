...
//			_, err := vultr.GetFirewallGroup(ctx, &vultr.LookupFirewallGroupArgs{
...
func LookupFirewallGroupOutput(ctx *pulumi.Context, args LookupFirewallGroupOutputArgs, opts ...pulumi.InvokeOption) LookupFirewallGroupResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFirewallGroupResultOutput, error) {
			...
			return ctx.InvokeOutput("vultr:index/getFirewallGroup:getFirewallGroup", args, LookupFirewallGroupResultOutput{}, options).(LookupFirewallGroupResultOutput), nil
