...
//			_, err := vultr.GetReverseIpv6(ctx, &vultr.LookupReverseIpv6Args{
...
func LookupReverseIpv6Output(ctx *pulumi.Context, args LookupReverseIpv6OutputArgs, opts ...pulumi.InvokeOption) LookupReverseIpv6ResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupReverseIpv6ResultOutput, error) {
			...
			return ctx.InvokeOutput("vultr:index/getReverseIpv6:getReverseIpv6", args, LookupReverseIpv6ResultOutput{}, options).(LookupReverseIpv6ResultOutput), nil
