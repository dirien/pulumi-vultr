...
type ObjectStorage struct {
	...
	TierId pulumi.IntOutput `pulumi:"tierId"`
}
...
func NewObjectStorage(ctx *pulumi.Context,
	...
	if args.TierId == nil {
		return nil, errors.New("invalid value for required argument 'TierId'")
	}
...
// The ID of the tier to deploy the storage under.
func (o ObjectStorageOutput) TierId() pulumi.IntOutput {
	return o.ApplyT(func(v *ObjectStorage) pulumi.IntOutput { return v.TierId }).(pulumi.IntOutput)
}
