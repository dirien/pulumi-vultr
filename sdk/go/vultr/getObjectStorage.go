...
//			_, err := vultr.GetObjectStorage(ctx, &vultr.LookupObjectStorageArgs{
...
func LookupObjectStorageOutput(ctx *pulumi.Context, args LookupObjectStorageOutputArgs, opts ...pulumi.InvokeOption) LookupObjectStorageResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupObjectStorageResultOutput, error) {
			...
			return ctx.InvokeOutput("vultr:index/getObjectStorage:getObjectStorage", args, LookupObjectStorageResultOutput{}, options).(LookupObjectStorageResultOutput), nil
