...
// The VPC ID to use when creating the server.
func (o BareMetalServerOutput) VpcId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *BareMetalServer) pulumi.StringPtrOutput { return v.VpcId }).(pulumi.StringPtrOutput)
}
