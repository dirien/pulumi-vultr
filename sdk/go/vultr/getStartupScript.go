...
//			_, err := vultr.GetStartupScript(ctx, &vultr.LookupStartupScriptArgs{
...
func LookupStartupScriptOutput(ctx *pulumi.Context, args LookupStartupScriptOutputArgs, opts ...pulumi.InvokeOption) LookupStartupScriptResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStartupScriptResultOutput, error) {
			...
			return ctx.InvokeOutput("vultr:index/getStartupScript:getStartupScript", args, LookupStartupScriptResultOutput{}, options).(LookupStartupScriptResultOutput), nil
